...
@section('content')
    ...
    <div class="card painel">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cedentes.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mt-4">
                    <div class="col-md-6">
                        <label class="labels-form">Cedente</label>
                        <input id="1" name="descricao" type="text" class="form-control form-control-sm"
                            placeholder="digite o cedente" value="{{old('descricao')}}">
                            @error('descricao')
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <button id="3" class="btn btn-sm btn-primary form-button" type="submit">Gravar</button>
